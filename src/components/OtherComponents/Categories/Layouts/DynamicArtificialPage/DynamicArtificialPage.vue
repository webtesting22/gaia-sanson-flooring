<template>
  <div>
    <CommonTopLayout
      :heading="grassData.heading"
      :imageSrc="grassData.imageSrc"
      :imageAlt="grassData.imageAlt"
    />
        ...
        <div class="grassContentSection">
          ...
          <div class="contentSection">
            ...
            <div class="idealForTags">
              <div
                v-for="application in grassData.idealFor"
                :key="application"
                class="tag"
              >
                {{ application }}
          ...
          <div class="contentSection">
            ...
            <ul class="specificationsList">
              <li
                v-for="spec in grassData.specifications"
                :key="spec"
                class="specItem"
              >
    ...
    <div class="Container paddingTop40 paddingBottom80">
      <div class="landscapeHeader">
        ...
        <div class="headerRight">
          <p class="landscapeDescription">
            {{ grassData.landscapeDescription }}
          </p>
        </div>
      </div>
      ...
      <div class="landscapeCarousel paddingTop40" v-if="showSwiper">
        ...
        >
          <swiper-slide
            v-for="(image, index) in landscapeImages"
            :key="index"
...
const grassTypesData = {
  "landscape-grass": {
    ...
    imageSrc:
      "https://s3.ap-south-1.amazonaws.com/prepseed/prod/ldoc/media/LandScapeMainImage.jpg",
    imageAlt: "Landscape Grass",
    title: "Landscape Grass",
    mainImage:
      "https://s3.ap-south-1.amazonaws.com/prepseed/prod/ldoc/media/GrassnewIage.png",
    insetImage:
      "https://s3.ap-south-1.amazonaws.com/prepseed/prod/ldoc/media/LandScapeMainImage.jpg",
    overview:
      "Perfect for lush gardens, terraces, and outdoor aesthetics, our Landscape Grass combines premium softness with lasting durability.",
    idealFor: ["Villas", "Rooftops", "Hotel Lawns", "Public Parks"],
    specifications: [
      "Available in multiple stitch options (13-30) for varied density and feel.",
      "Wide range of pile heights (18mm-55mm) to match all design intents - from minimalist to luxurious lawns.",
      "Customizable single/double layers & color backing (black or green).",
      "Made with various yarn deniers to suit particular requirements.",
    ...
    landscapeDescription:
      "See how Landscape Grass transforms outdoor spaces — creating lush, natural-looking gardens and terraces that enhance any property.",
  },
  "sports-grass": {
    ...
    idealFor: [
      "Football",
      "Rugby",
      "Athletic Training Fields",
      "School Grounds",
    ],
    specifications: [
      "14-16 stitch density",
      "35-50mm pile heights",
      "9000-16000 DTex PE yarn for enhanced shock absorption and playability",
    ],
    images: [
      {
        src: "https://s3.ap-south-1.amazonaws.com/prepseed/prod/ldoc/media/SportGrassimage.jpg",
        alt: "Sports Grass Football Field - 50mm",
      },
      {
        src: "/Images/GrassImages/SportsGrass1.jpg",
        alt: "Sports Grass Rugby Field - 50mm",
      },
      {
        src: "/Images/GrassImages/SportsGrass2.jpg",
        alt: "Sports Grass Training Field - 50mm",
      },
      {
        src: "/Images/GrassImages/SportsGrass3.jpg",
        alt: "Sports Grass School Ground - 50mm",
      },
      {
        src: "/Images/GrassImages/SportsGrass4.jpg",
        alt: "Sports Grass Athletic Track - 50mm",
      },
      {
        src: "/Images/GrassImages/SportsGrass5.jpg",
        alt: "Sports Grass Professional Stadium - 50mm",
      },
    ],
    landscapeTitle: "Explore Sports Grass Installations",
    landscapeDescription:
      "Explore sports grass installations, engineered for durability, performance, and excellence across various sports fields.",
  },
  "multisports-grass": {
    heading: "MultiTurf",
    ...
    specifications: [
      ...
      "5200 DTex mono yarn for even texture and wear resistance.",
    ],
    images: [
      {
    ...
    landscapeDescription:
      "Discover MultiTurf installations, designed to withstand the demands of various sports while providing superior performance and durability.",
  },
  "curly-grass": {
    heading: "Curly Grass",
    imageSrc: "/Images/curly-grass.jpeg",
    imageAlt: "Curly Grass",
    title: "Curly Grass",
    mainImage: "/Images/curly-grass.jpeg",
    insetImage: "/Images/curly-grass.jpeg",
    overview:
      'With a textured, "thatched" look, Curly Grass is a great base for low-maintenance areas or accent zones.',
    idealFor: [
      "Walkways",
      "Balcony Layers",
    ...
    specifications: [
      ...
      "3000 DTex mono yarn ideal for decorative & underlayer use",
    ...
    landscapeDescription:
      "Browse curly grass installations, offering natural beauty and texture, perfect for transforming both residential and commercial landscapes.",
  },
};
